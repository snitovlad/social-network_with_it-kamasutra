   ...
   return (
      <div className={s.postsBlock}>
         ...
         <div className={s.posts}>
            <Post message={postData[0].message} likeCount={postData[0].likeCount} avatar={postData[0].avatar} />
            <Post message={postData[1].message} likeCount={postData[1].likeCount} avatar={postData[1].avatar} />
            <Post message={postData[2].message} likeCount={postData[2].likeCount} avatar={postData[2].avatar} />
